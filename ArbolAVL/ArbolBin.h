...
int esLLeno(Arbin a){
	if(AlturaAB(izqAB(a))==AlturaAB(derAB(a)) && esLLeno(izqAB(a))&& esLLeno(derAB(a)))
		return 1;
	else
		return 0;
}
Arbin hazCompleto(Elem e, Arbin a){
    if((AlturaAB(izqAB(a))== (AlturaAB(derAB(a))+1) &&  esLLeno(izqAB(a))) || (AlturaAB(izqAB(a))==AlturaAB(derAB(a)) && !esLLeno(derAB(a))))
